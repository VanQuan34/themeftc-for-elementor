 ...
 */
function ftc_elements_loop_post_func($style_blog = '', $style = 'style_1', $grid = '', $show_thumb = true, $img_format = 'thumbnail', $meta = true, $meta_ordering = [], $excerpt = true, $excerpt_limit = 20, $show_com = false, $css_class = '' ) {
	?>
