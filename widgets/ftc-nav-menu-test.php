...
class Ftc_Nav_Menu extends Widget_Base {
	...
	public function get_title() {
		return __( 'Nav Menu', 'ftc-element' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label'     => __( 'Main Menu', 'ftc-element' ),
		...
		$this->add_control(
			...
			[
				'type'  => Controls_Manager::HEADING,
				'label' => __( 'Menu Item', 'ftc-element' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Pointer Color', 'ftc-element' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
		...
		$this->add_control(
			'pointer_width',
			[
				'label'     => __( 'Pointer Width', 'ftc-element' ),
		...
		$this->add_responsive_control(
			'menu_space_between',
			[
				'label'     => __( 'Space Between', 'ftc-element' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'max' => 100,
...
Plugin::instance()->widgets_manager->register_widget_type( new Ftc_Nav_Menu() );
