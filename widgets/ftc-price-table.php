...
class Ftc_Pricing_Table extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $repeater->add_control(
            'ftc_pricing_table_list_icon_new',
            [
                'label'            => esc_html__( 'List Icon', 'ftc-element' ),
                'type'             => Controls_Manager::ICONS,
        ...
        $repeater->add_control(
            'ftc_pricing_table_list_icon_color',
            [
        ...
        $repeater->add_control(
            'ftc_pricing_item_tooltip_content',
            [
        ...
        $repeater->add_control(
            'ftc_pricing_item_tooltip_trigger',
            [
        ...
        $repeater->add_control(
            'ftc_pricing_item_tooltip_animation',
            [
        ...
        $repeater->add_control(
            'ftc_pricing_table_toolip_arrow',
            [
        ...
        $repeater->add_control(
            'ftc_pricing_item_tooltip_theme',
            [
